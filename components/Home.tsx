            ...
            <section className="bg-gradient-to-t from-[#030303] to-[#363636]">
                <div className="relative overflow-hidden border-b border-white/5">
                    <div className="relative w-full mx-auto max-w-7xl">
                        <div className="relative flex flex-col w-full p-5 mx-auto lg:px-20 md:flex-row md:items-center md:justify-between md:px-6" x-data="{ open: false }">
                            ...
                            <nav className="flex-col items-center flex-grow hidden md:flex md:flex-row md:justify-end md:pb-0">
                                <a href="#_" className="px-2 py-2 text-sm font-medium text-white hover:text-white/50 lg:px-6 md:px-3 lg:ml-auto">Pricing</a>
                                <a href="#_" className="px-2 py-2 text-sm font-medium text-white hover:text-white/50 lg:px-6 md:px-3">Docs</a>
                    ...
                    <div className="relative items-center w-full px-5 pt-12 mx-auto max-w-7xl lg:pt-36 lg:px-16 md:px-12">
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            <p className="max-w-xl mx-auto mt-8 text-base lg:text-xl text-slate-300">
                                open-source projects on platforms like GitHub, GitLab, or Bitbucket, and contribute to them. Resources like Open Source Guides, First Timers Only, and Hacktoberfest can guide beginners in making meaningful contributions.
                            </p>
                        </div>
                        <div className="flex flex-col justify-center gap-3 mt-10 sm:flex-row">
                            <a href="#_" className="items-center inline-flex focus:outline-none justify-center text-white bg-[#5b03e3] duration-200 focus-visible:outline-black focus-visible:ring-black font-medium hover:bg-transparent hover:border-white hover:text-white lg:w-auto px-6 py-3 rounded-full text-center w-full">Get started</a>
                        </div>
                    </div>
