...
const members = [
    {
        company_icon: <svg className="w-8 h-8" viewBox="0 0 35 35" fill="none" xmlns="https://avatars.githubusercontent.com/u/13742415?s=48&v=4">
        ...
        ,
        company_name: "Mediko",
        repo_title: "serverless",
        repo_description: "https://github.com/serverless/components",
        repo_url: "https://github.com/serverless/components"
    }, {
        company_icon: <svg className="w-8 h-8" viewBox="0 0 48 48" fill="none" xmlns="https://avatars.githubusercontent.com/u/56084650?s=48&v=4">
        ...
        company_name: "Find_Me",
        repo_title: "Find_Me_Issue",
        repo_description: "A React.js based web-app to find repositories containing 'good first issues' open source contribution. Any kind of contribution and suggestions are highly appreciated!",
        repo_url: "https://github.com/version0chiro/Find-Me-Issues"
    }, {
        company_icon: <svg className="w-8 h-8" viewBox="0 0 43 48" fill="none" xmlns="https://avatars.githubusercontent.com/u/1335450?s=48&v=4">
        ...
        company_name: "Figma",
        repo_title: "JSHiNT",
        repo_description: "JSHint is a tool that helps to detect errors and potential problems in your JavaScript code",
        techStack: "Full-time",
        location: "Mauritania",
        repo_url: "https://github.com/jshint/jshint",
    }
]
        ...
        <>
            ...
            <section className='m-5' >
                <div className=" m-10 p-4 md:px-8 bg-[#262626] rounded">
                    <h1 className='flex justify-center text-white  font-bold ' style={{ fontSize: '40px', fontWeight: 'bold' }}>ALL REPOSITORY</h1>
                    ...
                    <ul className="mt-12 divide-y space-y-3 ">
                        {
                            members.map((item, idx) => (
                                <li key={idx} className="px-5 py-12 duration-150 hover:border-white hover:rounded-xl hover:bg-black">
                                    <a href={item.path} className="m-4 flex justify-between">
                                        <div>
                                            <div className="flex items-center gap-x-3">
                                                <div className="bg-white p-5 text-white w-14 h-14 border rounded-full flex items-center justify-center">
                                                    {item.company_icon}
                                                </div>
                                                <div>
                                                    <span className="block p-3 text-lg text-indigo-600 font-medium">{item.company_name}</span>
                                                    <h3 className="text-base p-4 text-white font-semibold mt-1">{item.repo_title}</h3>
                                                </div>
                                            </div>
                                        ...
                                        <button
                                            type="button"
                                            className=" flex justify-center w-64 h-10 mt-10 bg-white  inline-block rounded bg-neutral-800 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-neutral-100 shadow-[0_4px_9px_-4px_rgba(51,45,45,0.7)] transition duration-150 ease-in-out hover:bg-neutral-800 hover:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] focus:bg-neutral-800 focus:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] focus:outline-none focus:ring-0 active:bg-neutral-900 active:shadow-[0_8px_9px_-4px_rgba(51,45,45,0.2),0_4px_18px_0_rgba(51,45,45,0.1)] dark:bg-neutral-900 dark:shadow-[0_4px_9px_-4px_#030202] dark:hover:bg-neutral-900 dark:hover:shadow-[0_8px_9px_-4px_rgba(3,2,2,0.3),0_4px_18px_0_rgba(3,2,2,0.2)] dark:focus:bg-neutral-900 dark:focus:shadow-[0_8px_9px_-4px_rgba(3,2,2,0.3),0_4px_18px_0_rgba(3,2,2,0.2)] dark:active:bg-neutral-900 dark:active:shadow-[0_8px_9px_-4px_rgba(3,2,2,0.3),0_4px_18px_0_rgba(3,2,2,0.2)]"
